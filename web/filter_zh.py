...
from keywords import zh_crypto_words  # 或者你的英文关键词列表变量名
from tqdm import tqdm

# 配置区
PARQUET_FOLDER = r'C:\Users\DGT_X\Desktop\crypto\zh_downloads'
SAVE_ROOT      = r'C:\Users\DGT_X\Desktop\crypto\zh_crypto'
LANG           = 'zh'

THRESHOLD = {'zh': {'HIT_TIMES_THRESHOLD': 5, 'HIT_RATIO_THRESHOLD': 0.05},}
...
class CryptoTextFilter:
    ...
    def match_keywords(self, text, en_like=False):
        """
    ...
    def filter_data(self):
        ...
        pool = multiprocessing.Pool(processes=min(20, len(files)))
