...
# 目标网页 URL
url = 'https://www.usenix.org/legacy/publications/library/proceedings/sec96/'

# 提取年份
year = '1996'  # 手动指定年份，因为URL结构可能不同
...
def crawl_page(url):
    try:
        ...
        for dt_tag in dt_tags:
            ...
            a_tag = dt_tag.find('a')
            if a_tag and a_tag.find('i'):
                title = a_tag.find('i').get_text(strip=True)
