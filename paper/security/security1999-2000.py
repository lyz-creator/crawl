...
# 目标网页 URL 列表
urls = [
    'https://www.usenix.org/legacy/events/sec00/technical.html'
]
...
def crawl_page(url):
    ...
    # 创建该年份的下载目录
    year_folder = r"C:\Users\lyz\Desktop\crawler\Security\Security_2000"
    ...
    if response.status_code == 200:
        ...
        for p_tag in p_tags:
            # 在 p 标签中查找 a 标签，且 a 标签的 href 属性以 .html 结尾
            a_tag = p_tag.find('a', href=re.compile(r'.*\.html$'))
            if a_tag:
